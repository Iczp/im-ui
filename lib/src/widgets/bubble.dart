    ...
    return ClipPath(
      ...
      child: Container(
        ...
        decoration: decoration ??
            BoxDecoration(
              // border: Border.all(color: Color.fromARGB(255, 250, 25, 0)),
              color: color,
              // boxShadow: const [
        ...
        padding: EdgeInsets.fromLTRB(_left, 0.0, _right, 0.0)
            .add(padding ?? const EdgeInsets.fromLTRB(10.0, 10.0, 10.0, 10.0)),
        child: child,
      ),
    );
  }
