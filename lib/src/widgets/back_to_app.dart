...
class BackToApp extends StatefulWidget {
  ...
  @override
  State<BackToApp> createState() => _BackToAppState();
}

class _BackToAppState extends State<BackToApp> {
  ...
  /// Returns whether the [BackToApp.snackBar] is currently visible.
  ...
  Future<bool> _handleWillPop() async {
    if (_isSnackBarVisible || _willHandlePopInternally) {
      return await widget.onBack?.call() ?? true;
    }
